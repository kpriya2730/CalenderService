...
public class CreateEventConflictsCheckedStrategy implements CreateEventStrategy{
    private CreateEventStrategyType type = CreateEventStrategyType.CONFLICTS_CHECKED;
    @Override
